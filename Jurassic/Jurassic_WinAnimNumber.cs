...
public class Jurassic_WinAnimNumber : MonoBehaviour {
	...
	public Anaimation_Player m_AnimPlayer;
	int Index = 0;
	float Timer = 0.0f;
	bool Init = false;
	AtlasLoad m_atlas;
	...
	void Start () {
		m_atlas = GetComponent<AtlasLoad> ();
        m_MainSprite = this.GetComponent<UISprite>();
        m_AnimPlayer = this.GetComponentInChildren<Anaimation_Player>();
